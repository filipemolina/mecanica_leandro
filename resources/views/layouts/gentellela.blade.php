    ...
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a href="tables_dynamic.html">Sair</a></li>
                    </ul>
        ...
        <div class="top_nav">
          <div class="nav_menu">
            <nav>
              ...
              <div class="nav navbar-nav navbar-left top_search" style="margin-top: 15px;">
              ...
              <div class="nav navbar-nav btn-novo-carro">
                <div class="input-group">
                  <button class="btn btn-info">Cadastrar Carro</button>
                </div>
              </div>
        ...
        <!-- page content -->
          ...
          <div class="right_col" role="main" style="min-height: 1706px">
